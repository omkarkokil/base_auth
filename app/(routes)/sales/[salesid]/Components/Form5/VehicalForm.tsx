...
const VehicalForm: React.FC<CruiseProps> = ({ id }) => {
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button type="button" className="bg-primary gap-2 hover:bg-primary">
              <CarTaxiFront /> Add new vehical requisition
            </Button>
          </DialogTrigger>
          <VehicalModal
            open={open}
              ...
              <TableRow>
                ...
                >
                  <div className="flex bg-[#dcfce7] rounded-md p-8  shadow-md   gap-4 w-full ">
                    <CarTaxiFront className="h-12 w-12 text-success" />
                    <div className="flex flex-col items-start">
                      <h1 className="text-2xl pb-2 font-semibold text-success">
                        Create vehical requisition / This also can be empty
                      </h1>
                      <p className="font-medium text-left text-sm  text-success">
                        Please create vehical first by using add new vehical
                        requisition button for preview if no vehical also click
